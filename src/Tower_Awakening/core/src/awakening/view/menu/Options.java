...
public class Options implements Screen {
	...
	public Options(TAGame game, Music sound, Sound effect) {
		...
		background = new Texture(
				Gdx.files.internal("img/menu/Background-1.png"));
		...
		// /Graphics Button
		btnGraphics = new TextButton(language.getString("button_graphics"),
				skin);

		// /Controls Button
		btnControls = new TextButton(language.getString("button_controls"),
				skin);
	...
	public void show() {
		...
		btnControls.setPosition(Gdx.app.getGraphics().getWidth() / 2
				- widgetsBackground.getWidth() / 2 + 10, Gdx.app.getGraphics()
				.getHeight()
				/ 2
		...
		btnGraphics.setPosition(Gdx.app.getGraphics().getWidth() / 2
				- widgetsBackground.getWidth() / 2 + 10, Gdx.app.getGraphics()
				.getHeight()
				/ 2
				- widgetsBackground.getHeight()
		...
		btnAudio.setPosition(Gdx.app.getGraphics().getWidth() / 2
				- widgetsBackground.getWidth() / 2 + 10, Gdx.app.getGraphics()
				.getHeight()
				/ 2
				- widgetsBackground.getHeight()
