...
public class Controls implements Screen {
	...
	public Controls(TAGame game, Music sound, Sound effect) {
		...
		background = new Texture(
				Gdx.files.internal("img/menu/Background-4.png"));
		...
		widgetsBackground = new Image(new Texture(
				Gdx.files.internal("img/widget/window_large.png")));
	...
	public void show() {
		...
		btnBack.setPosition(
				...
				Gdx.app.getGraphics().getHeight() / 2
						- widgetsBackground.getHeight() / 2 + 30);
		...
		btnLeft.setPosition(
				Gdx.app.getGraphics().getWidth() / 2 - btnLeft.getWidth() / 2,
				Gdx.app.getGraphics().getHeight() / 2
						- widgetsBackground.getHeight() / 2 + 30 + 3
						* btnBack.getHeight());
		...
		lblLeft.setPosition(btnLeft.getX() - lblLeft.getWidth() - 10, Gdx.app
				.getGraphics().getHeight()
				/ 2
				- widgetsBackground.getHeight()
				/ 2 + 30 + 3 * btnBack.getHeight());
		stage.addActor(lblLeft);

		// /Right Button
		btnRight.setWidth(widgetsBackground.getWidth() / 2.5f - 20);
		btnRight.setPosition(
				Gdx.app.getGraphics().getWidth() / 2 - btnRight.getWidth() / 2,
				Gdx.app.getGraphics().getHeight() / 2
						- widgetsBackground.getHeight() / 2 + 30 + 2
						* btnBack.getHeight());
		...
		lblRight.setPosition(
				btnRight.getX() - lblRight.getWidth() - 10,
				Gdx.app.getGraphics().getHeight() / 2
						- widgetsBackground.getHeight() / 2 + 30 + 2
						* btnBack.getHeight());
		...
		btnDown.setPosition(
				Gdx.app.getGraphics().getWidth() / 2 - btnDown.getWidth() / 2,
				Gdx.app.getGraphics().getHeight() / 2
						- widgetsBackground.getHeight() / 2 + 30 + 4
						* btnLeft.getHeight());
		...
		lblDown.setPosition(btnDown.getX() - lblDown.getWidth() - 10, Gdx.app
				.getGraphics().getHeight()
				/ 2
				- widgetsBackground.getHeight()
				/ 2 + 30 + 4 * btnLeft.getHeight());
		stage.addActor(lblDown);

		// /Up Button
		btnUp.setWidth(widgetsBackground.getWidth() / 2.5f - 20);
		btnUp.setPosition(
				Gdx.app.getGraphics().getWidth() / 2 - btnUp.getWidth() / 2,
				Gdx.app.getGraphics().getHeight() / 2
						- widgetsBackground.getHeight() / 2 + 30 + 5
						* btnDown.getHeight());
		...
		lblUp.setPosition(btnUp.getX() - lblUp.getWidth() - 10, Gdx.app
				.getGraphics().getHeight()
				/ 2
				- widgetsBackground.getHeight()
				/ 2 + 30 + 5 * btnDown.getHeight());
		stage.addActor(lblUp);

		// /Zoom In Button
		btnZoomIn.setWidth(widgetsBackground.getWidth() / 2.5f - 20);
		btnZoomIn.setPosition(
				Gdx.app.getGraphics().getWidth() / 2 - btnUp.getWidth() / 2,
				Gdx.app.getGraphics().getHeight() / 2
						- widgetsBackground.getHeight() / 2 + 30 + 6
						* btnBack.getHeight());
		...
		lblZoomIn.setPosition(
				btnZoomIn.getX() - lblZoomIn.getWidth() - 10,
				Gdx.app.getGraphics().getHeight() / 2
						- widgetsBackground.getHeight() / 2 + 30 + 6
						* btnBack.getHeight());
		...
		btnZoomOut.setPosition(
				Gdx.app.getGraphics().getWidth() / 2 - btnZoomOut.getWidth()
						/ 2,
				Gdx.app.getGraphics().getHeight() / 2
						- widgetsBackground.getHeight() / 2 + 30 + 7
						* btnBack.getHeight());
		...
		lblZoomOut.setPosition(
				btnZoomOut.getX() - lblZoomOut.getWidth() - 10,
				Gdx.app.getGraphics().getHeight() / 2
						- widgetsBackground.getHeight() / 2 + 30 + 7
						* btnBack.getHeight());
		...
		slbLangages.setPosition(
				Gdx.app.getGraphics().getWidth() / 2 - slbLangages.getWidth()
						/ 2,
				Gdx.app.getGraphics().getHeight() / 2
						- widgetsBackground.getHeight() / 2 + 30 + 9
						* btnBack.getHeight());
		slbLangages.addListener(new ChangeListener() {
			...
			public void changed(ChangeEvent event, Actor actor) {
				...
				if (slbLangages.getSelected().equals("English")) {
					...
					try {
						language = ResourceBundle.getBundle(
								"awakening.menu.res_en_EN", locales[0]);
					} catch (java.util.MissingResourceException e) {
					...
					try {
						language = ResourceBundle.getBundle(
								"awakening.menu.res_fr_FR", locales[1]);
					} catch (java.util.MissingResourceException e) {
					...
					try {
						language = ResourceBundle.getBundle(
								"awakening.menu.res_it_IT", locales[2]);
					} catch (java.util.MissingResourceException e) {
		...
		lblLangage.setPosition(
				slbLangages.getX() - lblLangage.getWidth() - 10,
				Gdx.app.getGraphics().getHeight() / 2
						- widgetsBackground.getHeight() / 2 + 30 + 9
						* btnBack.getHeight());
