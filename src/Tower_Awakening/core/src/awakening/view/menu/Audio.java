...
public class Audio implements Screen {
	...
	public void show() {
		...
		// /Music Slider
		sliderMusic.setPosition(Gdx.app.getGraphics().getWidth() / 2
				- widgetsBackground.getWidth() / 2 + 10, Gdx.app.getGraphics()
				.getHeight()
				/ 2
		...
		// /Music Label
		musicLabel.setPosition(Gdx.app.getGraphics().getWidth() / 2
				- widgetsBackground.getWidth() / 2 + 10, Gdx.app.getGraphics()
				.getHeight()
				/ 2
				- widgetsBackground.getHeight()
				/ 2
				+ 60
				+ sliderMusic.getHeight());
		stage.addActor(musicLabel);

		// /Sound Slider
		sliderEffects.setPosition(Gdx.app.getGraphics().getWidth() / 2
				- widgetsBackground.getWidth() / 2 + 10, Gdx.app.getGraphics()
				.getHeight()
				/ 2
				- widgetsBackground.getHeight()
				/ 2
				+ 80
				+ musicLabel.getHeight());
		sliderEffects.setValue(game.getSoundVolume() * 10);
		stage.addActor(sliderEffects);

		// /Sound Label
		soundLabel.setPosition(Gdx.app.getGraphics().getWidth() / 2
				- widgetsBackground.getWidth() / 2 + 10, Gdx.app.getGraphics()
				.getHeight()
				/ 2
				- widgetsBackground.getHeight()
