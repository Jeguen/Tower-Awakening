...
public class Multiplayer implements Screen {
	...
	public void show() {
		...
		btnBack.setPosition(Gdx.app.getGraphics().getWidth() / 2
		...
		btnJoin.setPosition(
				Gdx.app.getGraphics().getWidth() / 2 - btnJoin.getWidth() / 2
						- 10,
				Gdx.app.getGraphics().getHeight() / 2
						- widgetsBackground.getHeight() / 2 + 60 + 3
						* btnBack.getHeight());
		...
		btnCreate.setPosition(
				Gdx.app.getGraphics().getWidth() / 2 - btnJoin.getWidth() / 2
						- 10,
				Gdx.app.getGraphics().getHeight() / 2
						- widgetsBackground.getHeight() / 2 + 60 + 4
						* btnBack.getHeight());
		...
		tfdPort.setPosition(
				Gdx.app.getGraphics().getWidth() / 2 - tfdPort.getWidth() / 2,
				Gdx.app.getGraphics().getHeight() / 2
						- widgetsBackground.getHeight() / 2 + 70 + 5
						* btnBack.getHeight());
		tfdPort.setWidth(widgetsBackground.getWidth() / 2.5f - 20);
		stage.addActor(tfdPort);
		Label lblPort = new Label("Port :", skin);
		lblPort.setPosition(tfdPort.getX() - lblPort.getWidth() - 10, Gdx.app
				.getGraphics().getHeight()
				/ 2
				- widgetsBackground.getHeight()
				/ 2 + 70 + 5 * btnBack.getHeight());
		stage.addActor(lblPort);

		tfdIp.setPosition(
				Gdx.app.getGraphics().getWidth() / 2 - tfdIp.getWidth() / 2,
				Gdx.app.getGraphics().getHeight() / 2
						- widgetsBackground.getHeight() / 2 + 80 + 6
						* btnBack.getHeight());
		tfdIp.setWidth(widgetsBackground.getWidth() / 2.5f - 20);
		stage.addActor(tfdIp);
		Label lblIp = new Label("IP :", skin);
		lblIp.setPosition(tfdIp.getX() - lblIp.getWidth() - 10, Gdx.app
				.getGraphics().getHeight()
				/ 2
				- widgetsBackground.getHeight()
				/ 2 + 60 + 6 * btnBack.getHeight() + tfdIp.getHeight() / 2);
		...
		stage.addActor(btnCreate);
		btnJoin.setPosition(btnCreate.getX() + btnCreate.getWidth(), Gdx.app
				.getGraphics().getHeight()
				/ 2
				- widgetsBackground.getHeight()
				/ 2 + 60 + 4 * btnBack.getHeight());
