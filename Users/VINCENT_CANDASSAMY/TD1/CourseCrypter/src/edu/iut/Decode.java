...
public class Decode {
    ...
    /**
     * Message d'erreur qui specifie les parametres a mettre pour l'execution
     */
    public void usage()
    {
    ...
    /**
     * Fonction permettant de decrypter le fichier encoder
     * @param source fichier source crypter
     * @param destination fichier a récuper apres decryptage
     * @param key cle de decryptage 
     */
